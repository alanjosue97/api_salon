...
@router.post("")
async def create_category(create_category:CreateCategory, database: Annotated[AsyncIOMotorDatabase, Depends(get_db)]):
...
@router.get("")
async def get_all_categories( database: Annotated[AsyncIOMotorDatabase, Depends(get_db)]):
